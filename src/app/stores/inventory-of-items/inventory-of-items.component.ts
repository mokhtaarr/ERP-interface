...
@Component({
  selector: 'app-inventory-of-items',
  templateUrl: './inventory-of-items.component.html',
  styleUrls: ['./inventory-of-items.component.scss']
})
export class InventoryOfItemsComponent implements OnInit {
