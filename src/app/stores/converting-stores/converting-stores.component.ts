...
@Component({
  selector: 'app-converting-stores',
  templateUrl: './converting-stores.component.html',
  styleUrls: ['./converting-stores.component.scss']
})
export class ConvertingStoresComponent implements OnInit {
