...
@Component({
  selector: 'app-update-item-unit',
  templateUrl: './update-item-unit.component.html',
  styleUrls: ['./update-item-unit.component.scss']
})
export class UpdateItemUnitComponent implements OnInit {
  ItemData: any;
  ...
  constructor(
    ...
    private ref: MatDialogRef<UpdateItemUnitComponent>,
  ...
  onSumbit(){
    this.definitionService.UpdateItemUnit(this.itemUnitForm.value).subscribe(res=>{
      this.AddItemUnit_Response = res.status;
      this.closepopup();
    })
  }
